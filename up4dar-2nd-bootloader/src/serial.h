...
xComPortHandle xSerialPortInitMinimal( int uartNumber, unsigned long ulWantedBaud, unsigned portBASE_TYPE uxQueueLength );
...
extern unsigned long serialRXError;
extern unsigned long serialRXOK;
